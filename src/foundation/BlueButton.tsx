...
const ButtonStyled = styled(MUIButton)(({ theme }) => ({
  '&.MuiButton-contained': {
    ...
    '&:hover': {
      backgroundColor: theme.palette.primary.dark, // Same color on hover
    },
  },
  '&.MuiButton-outlined': {
    border: 0,
...
export const BlueButton: React.FC<IProps> = ({ onClick, disabled, caption, icon, isDialog, secondary }) => {
